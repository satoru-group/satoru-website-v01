        ...
        <div className="max-w-6xl mx-auto w-full flex flex-col justify-center flex-1">
          ...
          <div className="flex flex-col lg:hidden gap-4 mb-3">
            ...
            <div className="grid grid-cols-2 gap-3 items-start">
              {/* Mobile Left - Heading and decoration */}
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <img 
                      ...
                      alt="" 
                      className="w-32 h-32 object-contain opacity-10 dark:opacity-20 animate-float-subtle"
                      style={{ 
                  ...
                  <h1 className="relative z-10 text-lg font-bold text-[#27254c] dark:text-foreground leading-tight">
              ...
              {/* Mobile Right - AI Image */}
              <div className="relative group w-full">
                <div className="relative overflow-hidden rounded-lg shadow-glow-cyan border-2 border-primary/30 hover:border-primary/50 transition-all duration-500 group-hover:shadow-glow-purple scan-lines aspect-square">
                  <img 
                    src={aiTechnology} 
                ...
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-primary rounded-full animate-digital-pulse opacity-80" />
                <div className="absolute -bottom-1 -left-1 w-2 h-2 bg-accent rounded-full animate-float-dynamic opacity-60" />
                <div className="absolute top-1/2 -left-2 w-2 h-2 bg-primary rounded-full animate-digital-pulse opacity-70" />
              </div>
            </div>
            
            {/* Mobile: Description text */}
            <div className="data-stream">
              <p className="text-xs text-[#1f232f] dark:text-muted-foreground leading-relaxed px-1">
