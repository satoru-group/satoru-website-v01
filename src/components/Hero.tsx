...
const Hero = ({ showArrow = false }: HeroProps) => {
  ...
  return (
    <section className="relative w-full flex flex-col bg-background overflow-hidden pt-[120px] sm:pt-[68px] lg:pt-[72px] lg:min-h-screen min-h-[120vh] sm:min-h-screen">
            ...
            <div className="w-full max-w-md mx-auto space-y-12">
              ...
              <div className="text-center space-y-8 px-4">
                <div className="relative py-8">
                  ...
                  <h1 className="relative z-20 text-6xl sm:text-7xl font-bold leading-[1.1] text-center">
