...
const AboutUsSection = ({ showArrow = false }: AboutUsSectionProps) => {
  return (
    <section className="w-full h-full bg-background flex items-center justify-center relative overflow-hidden px-3 sm:px-4 lg:px-6 pt-20 sm:pt-24 lg:pt-28">
      ...
      {/* Large Microchip with Electric Animation Background - Smaller for mobile */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 sm:w-80 h-60 sm:h-80 opacity-15 dark:opacity-25 animate-float-subtle">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-6 lg:space-y-8 relative z-10 w-full">
        ...
        <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-4 sm:mb-6 lg:mb-8">
        ...
        <Button variant="outline" size="lg" className="text-sm px-4 sm:px-6 py-2 sm:py-3">
          Learn More
        </Button>
      ...
      {/* Scroll Down Arrow */}
      {showArrow && (
        <div className="absolute bottom-2 sm:bottom-4 lg:bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
