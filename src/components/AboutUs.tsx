...
const AboutUs = () => {
  return (
    <section className="min-h-screen bg-gradient-subtle px-6 lg:px-12 py-20 pt-32 z-10 relative">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10 px-6 lg:px-12 flex items-center justify-center min-h-screen">        
